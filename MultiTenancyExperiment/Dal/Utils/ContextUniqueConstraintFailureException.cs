...
namespace MultiTenancyExperiment.Dal.Utils
{
    ...
    public class ContextUniqueConstraintFailureException : Exception
    {
        ...
        public ContextUniqueConstraintFailureException(string message) : base(message)
        {
        }

        public ContextUniqueConstraintFailureException(string message, Exception inner) : base(message, inner)
        {
        }
